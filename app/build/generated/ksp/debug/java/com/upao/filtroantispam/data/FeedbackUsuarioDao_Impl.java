...
public final class FeedbackUsuarioDao_Impl implements FeedbackUsuarioDao {
  ...
  @Override
  public FeedbackUsuarioEntity obtener(final String numero) {
    final String _sql = "SELECT * FROM feedback_usuario WHERE numero = ?";
    ...
    try {
      ...
      final int _cursorIndexOfMarcadoSpam = CursorUtil.getColumnIndexOrThrow(_cursor, "marcadoSpam");
      final int _cursorIndexOfFecha = CursorUtil.getColumnIndexOrThrow(_cursor, "fecha");
      final FeedbackUsuarioEntity _result;
      if (_cursor.moveToFirst()) {
        ...
        final long _tmpFecha;
        _tmpFecha = _cursor.getLong(_cursorIndexOfFecha);
        _result = new FeedbackUsuarioEntity(_tmpNumero,_tmpMarcadoSpam,_tmpFecha);
      } else {
        _result = null;
      }
      return _result;
